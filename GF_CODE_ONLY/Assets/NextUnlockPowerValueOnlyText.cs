// Assets/Scripts/UI/Taskbar/NextUnlockPowerValueOnlyText.cs
using System;
using TMPro;
using UnityEngine;
...
public sealed class NextUnlockPowerValueOnlyText : MonoBehaviour
{
    [Header("UI")]
    ...
    [Tooltip("Shown when TryGetNextUnlockPower returns false (meaning all unlocked).")]
    [SerializeField] private string allUnlockedText = "—";
    ...
    private void Apply(bool force)
    {
        ...
        string msg = styleValue ? StyleValue(raw) : raw;
