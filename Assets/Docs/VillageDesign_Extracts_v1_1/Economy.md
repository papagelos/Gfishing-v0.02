# Economy (Ticks, bonuses, refunds, caps)

Use this file when a ticket is about **tickSeconds**, bonus caps, refund factors, IP curves, storage guards, or anti-exploit rules.

This is mostly `Segment_08.md` under a friendly name.
