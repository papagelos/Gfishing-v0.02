# Roads (Adjacency + Connectivity)

Use this file when a ticket is about **road tags**, **connectivity**, **Town Hall network**, BFS/pathing, or road bonuses.

This is essentially `Segment_06.md` under a friendly name.
